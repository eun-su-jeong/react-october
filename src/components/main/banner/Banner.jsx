...
export default function Banner() {
	...
	// handleScroll에 대입되어 었는 함수가 컴포넌트 재랜더링시마다 계속 읽히기 때문에
	// useCallback을 토애서 강제로 메오리에 등록해서 기존함수내용을 재활용하는 메모이제이션 처리
	// 메모이제이션되는 순간 그안족의 모든 값들이 static하게 고정되어 버리므로
	// 의존성배열에 특정 값을 지정해서 대당 값이 변경시에는 임시로 메모이제이션 애제
